...
End If
oLink.Description = "동래고등학교 교사 시간표 윈도우 미니 위젯"
oLink.Save

' 2. 윈도우 시작 메뉴 바로가기 생성
programsPath = oWS.SpecialFolders("Programs")
Set oStartLink = oWS.CreateShortcut(programsPath & "\동래고 시간표 위젯.lnk")
...
End If
oStartLink.Description = "동래고등학교 교사 시간표 윈도우 미니 위젯"
oStartLink.Save

MsgBox "동래고 시간표 바탕화면 위젯이 바탕화면 및 시작 메뉴에 등록되었습니다!" & vbCrLf & vbCrLf & "바탕화면의 [🏫 동래고 시간표 위젯] 아이콘을 더블클릭하시면 컴팩트한 미니 위젯으로 실행됩니다.", 64, "위젯 등록 완료"
